<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_main.master" AutoEventWireup="true" CodeFile="hot_write.aspx.cs" Inherits="MasterOnly_hot_write" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="comu_wrap">
        <div class="h_content">
            <div> <span class="h_txt">핫딜+ 글쓰기</span>
            </div>
            <table id="hwrite_table" style="margin-left:100px;">
                <tr class="htr">
                    ...
                    <td class="auto-style3">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="DropDownList1" Display="None" ErrorMessage="[제목] 필수입력" style="color: #FF0000">*</asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr class="htr">
                    <td class="auto-style2">
                    ...
                    <td class="auto-style3">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="TextBox1" Display="None" ErrorMessage="[제목] 필수입력" style="color: #FF0000">*</asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr class="htr">
                    <td class="auto-style2">
                    ...
                    <td class="auto-style3">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="TextBox2" Display="None" ErrorMessage="[제목] 필수입력" style="color: #FF0000">*</asp:RequiredFieldValidator>
                    </td>
                ...
                <tr class="htr">
                    ...
                    <td class="auto-style3">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="TextBox3" Display="None" ErrorMessage="[제목] 필수입력" style="color: #FF0000">*</asp:RequiredFieldValidator>
                    </td>
                ...
                <tr class="htr">
                    ...
                    <td class="auto-style3">
                        <asp:FileUpload ID="FileUpload1" runat="server" Width="298px" BorderColor="Silver" BorderWidth="1px" BackColor="White" Height="30px" AllowMultiple="True" />
                    </td>
                </tr>
                <tr class="htr2">
                    <td class="htit2">
