<%@ Page Title="" Language="C#" MasterPageFile="/MasterPage_main.master" AutoEventWireup="true" CodeFile="noticeEdit.aspx.cs" Inherits="noticeWrite" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <link rel="stylesheet" type="text/css" href="../css/notice.css"/>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="notice_background3">
        <div class="notice_contain3">
            <span class="notice_title3">공지사항 수정</span>
            <hr class="notice_w_hr1"/>

            <div class="notice_write3">
                ...
                <div class="notice_w_btn3">
                    <div class="not_ed_bt1"><asp:ImageButton ID="oImageButton3" runat="server" CausesValidation="False" ImageUrl="~/Images/write_list.png" PostBackUrl="~/noticeList.aspx" /></div>
                    <div class="not_ed_bt2"><asp:ImageButton ID="oImageButton2" runat="server" ImageUrl="~/Images/write_bun.png" OnClick="ImageButton2_Click1" /></div>
                </div>
            </div>
    </div>
</asp:Content>
