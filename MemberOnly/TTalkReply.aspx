<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_main.master" AutoEventWireup="true" CodeFile="TTalkReply.aspx.cs" Inherits="MemberOnly_TalkWrite" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="comu_wrap">
        <div class="content">
            <div><span class="whirt_txt">&nbsp;톡톡 답변</span></div>
            ...
            <table id="pwrite_table" style="border-style: none; margin-left:100px;" border="0">
                ...
                <tr class="ptr">
                    ...
                    <td class="ptd">
                        <asp:TextBox ID="Ttit_textbox" runat="server" BorderColor="#CCCCCC" BorderWidth="1px" Height="30px" Width="600px" style="text-align: left"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" Display="None" ErrorMessage="[제목] 필수입력" ControlToValidate="Ttit_textbox" style="color: #FF3300">*</asp:RequiredFieldValidator>
                        <br />
                    </td>
                </tr>
