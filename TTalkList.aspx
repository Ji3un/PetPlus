<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_comu.master" AutoEventWireup="true" CodeFile="TTalkList.aspx.cs" Inherits="TalkList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="TalkWrap">
        ...
        <br />
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:myDBConnectionString1 %>" SelectCommand="SELECT [seq], [userID], [title], [body], [ref_id], [inner_id], [depth], [hit], [tDate], [deleted] FROM [TTalk] ORDER BY [ref_id] DESC, [inner_id]"></asp:SqlDataSource>
            <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:myDBConnectionString1 %>" 
                SelectCommand="select COUNT(seq) from TTalk"></asp:SqlDataSource>
            <br />
            <br />
            <br />
            <div class="textview_button">
                <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/Images/write_bun.png" PostBackUrl="~/MemberOnly/TTalkWrite.aspx"  />
            </div>
        <br />
            <br />
        <br />
