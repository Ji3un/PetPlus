<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_comu.master" AutoEventWireup="true" CodeFile="TalkEdit.aspx.cs" Inherits="TalkRead" %>
    ...
    <div class="comu_wrap">
        <div class="content">
            ...
            <table id="pwrite_table">
                ...
                <tr class="ptr" style="display:none;">
                    <td class="ptit">
                        <p>메뉴</p>
                    </td>
                    <td class="ptd">
...
&nbsp;<asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click" CausesValidation="False">파일삭제</asp:LinkButton>
        ...
        <asp:TextBox ID="twirte_textbox" runat="server" Height="500px" TextMode="MultiLine" Width="800px"></asp:TextBox>
         <br />
        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" Display="None" ErrorMessage="[내용] 필수입력" ControlToValidate="twirte_textbox"></asp:RequiredFieldValidator>
