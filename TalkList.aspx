    ...
    <div class="TalkWrap">
        ...
        <br />
            ...
            <Columns>
                ...
                <asp:BoundField DataField="wDate" DataFormatString="{0:yyyy_MM-dd}" HeaderText="작성" SortExpression="wDate">
                <HeaderStyle Width="120px" CssClass="gHeader" />
                <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:myDBConnectionString1 %>" SelectCommand="SELECT [seq], [userID], [title], [body], [ref_id], [inner_id], [depth], [hit], [wDate], [deleted] FROM [Talk] ORDER BY [ref_id] DESC, [inner_id]"></asp:SqlDataSource>
            <br />
            <br />
            <br />
